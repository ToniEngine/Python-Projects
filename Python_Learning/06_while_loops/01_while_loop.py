...
while i<=10:  # Is one less than or equals to 10? True, so pyhton loops through the code
    ...
    i = i +1  # Increments i by one snd goes back to the loop and checks the conditions again as long as it is True the loop continues and when loop is False, the loops ends and print the next line
